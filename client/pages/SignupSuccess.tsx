...
export default function SignupSuccess() {
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#035638] p-6 font-host">
      <div className="w-full max-w-[440px] bg-[#035638] rounded-3xl p-6 flex flex-col items-center">
